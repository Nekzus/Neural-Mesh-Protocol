...
The SDK's **Reactive Sync** engine will automatically inject this schema into the Agent's prompt and tool descriptions, enforcing a **Strict Schema Adherence** policy.
