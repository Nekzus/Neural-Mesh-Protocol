...
El motor de **Sincronización Reactiva** del SDK inyectará automáticamente este esquema en el prompt del Agente y en las descripciones de las herramientas, forzando una política de **Adherencia Estricta al Esquema**.
