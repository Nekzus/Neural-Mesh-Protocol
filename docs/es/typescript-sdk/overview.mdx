...
El SDK oficial `@neural-mesh/sdk` proporciona un conjunto de herramientas completo y fuertemente tipado para construir Clientes NMP (Agent Nodes) y Servidores NMP (Data Nodes) en TypeScript y JavaScript.
...
<CardGroup cols={3}>
  ...
  <Card title="NmpMcpBridge" icon="bridge-water" href="/es/typescript-sdk/server#nmpmcpbridge">
    El traductor de legado. Hace que los clientes MCP tradicionales sean compatibles con tu nueva red NMP.
  </Card>
</CardGroup>
