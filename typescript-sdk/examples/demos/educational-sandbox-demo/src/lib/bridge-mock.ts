 ...
 */
export async function server_node_exec(auditId: string, wasmPayload: Buffer): Promise<any> {
    ...
    console.log(`[NMP-BRIDGE] Routing Encrypted Capsule to Strategic-Data-Node-Alpha...`);
    ...
    const { result, receipt } = await WasiSandbox.execute(wasmPayload, { auditId });
