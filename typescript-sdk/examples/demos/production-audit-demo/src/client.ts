...
async function main() {
    console.log("------------------------------------------------------------------");
    console.log("   NMP PRODUCTION CLIENT - STARTING SECURE AUDIT                 ");
    console.log("------------------------------------------------------------------");

    try {
        await client.connect();
        console.log("[NMP-CLIENT] Calling remote 'audit_records' via Logic-on-Origin...");
        ...
        try {
            ...
            console.log("\n------------------------------------------------------------------");
            console.log("   AUDIT RESULTS RECEIVED                                         ");
            console.log("------------------------------------------------------------------");
            ...
            console.log("\n------------------------------------------------------------------");
            console.log("   SDK RAW SECURE RESPONSE                                       ");
            console.log("------------------------------------------------------------------");
